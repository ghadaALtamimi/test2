<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="NewPatient.aspx.cs" Inherits="AppVoice.Pages.NewPatient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="RegPanel" runat="server" DefaultButton="RegButton">
        ...
        <div class="container">
            <h2><span class="glyphicon glyphicon-edit"></span>&nbsp הוספת מטופל</h2>
